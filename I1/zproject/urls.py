...
from zerver.views.messages import get_recap, get_topic_suggestion
...
v1_api_and_json_patterns = [
    ...
    rest_path("messages/recap", GET=get_recap),
    rest_path("topic/suggest", GET=get_topic_suggestion),
