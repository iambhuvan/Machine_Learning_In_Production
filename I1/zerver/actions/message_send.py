...
def do_send_messages(
    ...
    *,
    ...
    # Topic drift detection hook - runs after all other processing
    from zerver.actions.topic_drift import maybe_queue_topic_drift_check
    for send_request in send_message_requests:
        if send_request.message.is_channel_message:
            maybe_queue_topic_drift_check(send_request.message)
